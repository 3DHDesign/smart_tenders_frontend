...
>
 ...
 <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4 leading-tight">
  Your Central Hub for All Tender Notices in Sri Lanka
 </h2>
 <p className="text-lg font-body mb-6">
  Stop searching through newspapers and scattered websites. Our platform centralizes all government and private tenders, helping you find and act on new procurement opportunities instantly.
 </p>

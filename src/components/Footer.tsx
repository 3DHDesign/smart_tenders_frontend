      ...
      <div ref={topRef} className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/how-it-works" className="text-gray-200 hover:text-[var(--color-primary)]">How It Works</Link></li>
              <li><Link to="/pricing" className="text-gray-200 hover:text-[var(--color-primary)]">Pricing</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tenders/today" className="text-gray-200 hover:text-[var(--color-primary)]">Today's Tenders</Link></li>
              <li><Link to="/tenders/live" className="text-gray-200 hover:text-[var(--color-primary)]">Live Tenders</Link></li>
              <li><Link to="/tenders/closed" className="text-gray-200 hover:text-[var(--color-primary)]">Closed Tenders</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs md:text-sm gap-2 md:gap-0">
          <p className="text-gray-400">
            &copy; {footerData.year} {footerData.companyName}. All rights reserved.
          </p>

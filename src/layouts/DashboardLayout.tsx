...
import { FaTachometerAlt, FaFileInvoice, FaLock, FaUser, FaHeart, FaBars, FaTimes } from 'react-icons/fa';
    ...
    <div className="flex flex-col min-h-screen bg-gray-100 font-body " >
      ...
      <div className="flex flex-grow ">
        ...
        >
          ...
          <Link to="/dashboard" className="hidden md:block text-2xl font-bold font-heading text-[var(--color-dark)] mb-8 mt-16">
        ...
        <main className="flex-grow bg-gray-100 overflow-y-auto  "> {/* Added mt-16 */}
